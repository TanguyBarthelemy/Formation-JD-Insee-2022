...
# Exemple d'option à poser :
# options(default_tsmatrix_series = c("y","sa","sa_f","s","s_f",
#                                     "ycal","cal","cal_f","d10","d10a"))
...
#     "espan.start", "espan.end", "espan.n", "log", "adjust", 
#     
#     "regression.lp", "regression.ntd", "regression.nmh", 
#     "regression.td-derived", "regression.td-ftest", "regression.easter", 
#     "regression.nout", "regression.noutao", "regression.noutls", 
#     "regression.nouttc", "regression.noutso", "regression.td(*):4", 
#     "regression.out(*)", "regression.user(*)", 
#     
#     "likelihood.neffectiveobs", "likelihood.np", "likelihood.logvalue", 
#     "likelihood.adjustedlogvalue", "likelihood.ssqerr", "likelihood.aic", 
#     "likelihood.aicc", "likelihood.bic", "likelihood.bicc", 
#     
#     "residuals.ser", "residuals.ser-ml", "residuals.mean", 
#     "residuals.skewness:3", "residuals.kurtosis:3", "residuals.dh", 
#     "residuals.lb", "residuals.lb2:3", "residuals.seaslb", "residuals.bp", 
#     "residuals.bp2", "residuals.seasbp", "residuals.nudruns", 
#     "residuals.ludruns", "residuals.nruns", "residuals.lruns", 
#     
#     "arima", "arima.mean", "arima.p", "arima.d",
#     "arima.q", "arima.bp", "arima.bd", "arima.bq", "arima.phi(*)",
#     "arima.bphi(*)", "arima.th(*)", "arima.bth(*)", 
#     
#     "decomposition.seasonality", "decomposition.parameters_cutoff", 
...
#     "decomposition.ar_root(*)", "decomposition.ma_root(*)",
#     
#     "method",
#     
...
#     
#     "diagnostics.logstat", "diagnostics.levelstat", 
...
#     "diagnostics.seas-lin-qs", "diagnostics.seas-lin-kw", 
...
#     "diagnostics.seas-res-f", "diagnostics.seas-res-qs", 
...
#     "diagnostics.seas-sa-kw", "diagnostics.seas-sa-friedman", 
#     "diagnostics.seas-sa-periodogram", "diagnostics.seas-sa-spectralpeaks", 
#     "diagnostics.seas-sa-combined", "diagnostics.seas-sa-combined3", 
#     "diagnostics.seas-sa-evolutive", "diagnostics.seas-sa-stable", 
#     "diagnostics.seas-sa-ac1", "diagnostics.td-sa-all", 
#     "diagnostics.td-sa-last", "diagnostics.td-i-all", "diagnostics.td-i-last", 
#     "diagnostics.td-res-all", "diagnostics.td-res-last", 
#     "diagnostics.ic-ratio-henderson", "diagnostics.ic-ratio", 
#     "diagnostics.msr-global", "diagnostics.msr(*)",
#     
...
#     "m-statistics.m9", "m-statistics.m10", "m-statistics.m11", 
