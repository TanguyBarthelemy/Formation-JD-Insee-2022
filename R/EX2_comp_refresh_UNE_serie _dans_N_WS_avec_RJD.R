...
# --> par exemple : voir les révisions avec 3 modes de refresh différents

# Dans l'exemple ci dessous :
#   - Chaque WS a été créé avec des refresh policy différents
#   - On va extraire la même série de chaque WS 
#   pour comparer les résultats en fonction de la refresh policy choisi
...
# W1: WorkSpace de reference : series de l'ipi jusqu'en septembre 2021
ch_1 <- "./WS/WS_ref.xml"
...
# name : méthode de refresh policy
...
# Ici on définit le "user-defined"  (séries pas présentes dans l'output par défaut)
# On ajoute :
...
# Récupération des composantes d'UNE SERIE dans chacun des WS de la liste
